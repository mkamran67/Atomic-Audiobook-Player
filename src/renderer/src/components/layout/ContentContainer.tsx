          ...
          <main className="lg:pr-96">
            ...
            <ul role="list" className="divide-y divide-white/5">
              {deployments.map((deployment) => (
                <li key={deployment.id} className="relative flex items-center px-4 py-4 space-x-4 sm:px-6 lg:px-8">
            ...
            <ul role="list" className="divide-y divide-white/5">
              {activityItems.map((item) => (
                <li key={item.commit} className="px-4 py-4 sm:px-6 lg:px-8">
                  <div className="flex items-center gap-x-3">
                    <img src={item.user.imageUrl} alt="" className="flex-none w-6 h-6 bg-gray-800 rounded-full" />
                    <h3 className="flex-auto text-sm font-semibold leading-6 text-white truncate">{item.user.name}</h3>
